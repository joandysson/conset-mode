    ...
    <main class="container">
        <section class="section-default">
            ...
            <p><span style="color: rgb(68, 68, 68);">
                    <h2><span style="color: rgb(68, 68, 68);">Cookie Policy for toolz</span></h2>
                    <p><span style="color: rgb(68, 68, 68);">This is the Cookie Policy for toolz, accessible from URL https://toolz.at/.</span></p>
                    ...
                    <p><span style="color: rgb(68, 68, 68);">
                            <ul>
                                <li><span style="color: rgb(68, 68, 68);">The Google AdSense service we use to serve advertising uses a DoubleClick cookie to serve more relevant ads across the web and limit the number of times that a given ad is shown to you.</span></li>
                                <li><span style="color: rgb(68, 68, 68);">For more information on Google AdSense see the official Google AdSense privacy FAQ.</span></li>
                                <li><span style="color: rgb(68, 68, 68);">We use adverts to offset the costs of running this site and provide funding for further development. The behavioural advertising cookies used by this site are designed to ensure that we provide you with the most relevant adverts where possible by anonymously tracking your interests and presenting similar things that may be of interest.</span></li>
                                <li><span style="color: rgb(68, 68, 68);">Several partners advertise on our behalf and affiliate tracking cookies simply allow us to see if our customers have come to the site through one of our partner sites so that we can credit them appropriately and where applicable allow our affiliate partners to provide any bonus that they may provide you for making a purchase.</span></li>
                            </ul>
                        </span>
                    </p>
                </span></p>
            ...
            <ul>
                ...
                <li><span style="color: rgb(68, 68, 68);">C) Do not cause damage to physical systems (hardware) and unattainable (software) of toolz, its suppliers or third parties, to introduce or disseminate computer viruses or any other hardware or software systems that are capable of causing damage previously mentioned.</span></li>
            </ul>
